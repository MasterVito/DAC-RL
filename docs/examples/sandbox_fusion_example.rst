...
1. **Access Full Documentation**: For detailed setup instructions, refer to the `Sandbox Fusion Documentation <https://XX.github.io/SandboxFusion/>`_.
2. **Deploy the Service**: Choose one of the following deployment methods:

   - **Local Deployment**: Follow the guide `here <https://XX.github.io/SandboxFusion/docs/docs/get-started#local-deployment>`_.
